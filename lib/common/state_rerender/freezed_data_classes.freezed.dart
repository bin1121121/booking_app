...
class _$RegisterObjectImpl implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(email: $email, userName: $userName, password: $password, confirmPassword: $confirmPassword)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, userName, password, confirmPassword);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String userName,
      final String password,
      final String confirmPassword) = _$RegisterObjectImpl;
